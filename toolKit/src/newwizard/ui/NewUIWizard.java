...
public class NewUIWizard extends Wizard implements INewWizard {
	...
	public void addPages() {
		...
		page = new NewUIPage(selection,"ui",rootPath);
		addPage(page);
	}
	...
	private InputStream openContentStream(String templateFile) {
		String contents =
			"<?xml version=\"1.0\" encoding=\"GBK\"?><UIContentsModel _class=\"ui.model.UIContentsModel\"></UIContentsModel>";
		if(templateFile!=null){
			contents = NewUIWizard.readFile(templateFile);
		}
