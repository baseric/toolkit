package business.dialog.openResource.dialogs;
...
import business.dialog.openResource.JavaTypeConstants;
import business.dialog.openResource.engine.JavaTypeItemsFilter;
import business.dialog.openResource.engine.JavaTypeSearchEngine;
import business.dialog.openResource.engine.JavaTypeSearchRequestor;
import business.dialog.openResource.history.JavaTypeSelectionHistory;
...
public class OpenJavaTypeByAuthorDialog extends SelectionStatusDialog {
	...
	public OpenJavaTypeByAuthorDialog(Shell parent,IProject project,String basePath,String extendName) {
		super(parent);
	...
	protected void fillContentProvider(JavaTypeContentProvider provider,
			...
			throws CoreException {
		JavaTypeItemsFilter pluginItemFilter = itemsFilter;
		...
		JavaTypeSearchEngine engine = new JavaTypeSearchEngine(requestor,project,basePath,extendName);
		try {
			engine.search();
		} catch (Exception e) {
			e.printStackTrace();
